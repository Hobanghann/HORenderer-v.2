...
class PipelineSettings : public InputListener {
 public:
  ...
  const uint32_t background_color() const;
  ...
  PipelineSettings& set_background_color(const uint32_t background_color);
 ...
 private:
  ...
  bool is_sphere_mode_ = true;
  InterpolationMode interpolation_mode_;
  bool is_affine_mode_ = true;
