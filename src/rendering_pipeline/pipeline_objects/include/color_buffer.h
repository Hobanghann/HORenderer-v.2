#ifndef _HORENDERER_ENGINE_COLOR_BUFFER_H_
#define _HORENDERER_ENGINE_COLOR_BUFFER_H_
...
class ColorBuffer {
 public:
  ...
  void InjectExternalBuffer(std::uint32_t* color_buffer);
...
#endif  // _HORENDERER_ENGINE_COLOR_BUFFER_H_