#ifndef _HORENDERER_MATRIX2X2_H_
#define _HORENDERER_MATRIX2X2_H_
...
inline Matrix2x2 operator*(float scalar, const Matrix2x2& matrix) {
  return Matrix2x2(scalar * matrix.col1(), scalar * matrix.col2());
}
}  // namespace ho_renderer

#endif  // _HORENDERER_MATRIX2X2_H_