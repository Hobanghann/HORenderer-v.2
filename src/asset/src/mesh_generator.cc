...
Mesh* MeshGenerator::GenerateSphere(const std::string& name,
  ...
  std::vector<LinearRGB> color_buffer(index_buffer.size() / 3.f, color);
...
Mesh* MeshGenerator::GenerateSphere(
    ...
    const float radius, const std::vector<LinearRGB>& color_buffer) {
  std::vector<Vertex> vertex_buffer;
...
Mesh* MeshGenerator::GenerateLine(const std::string& name, const float length,
  ...
  std::vector<LinearRGB> color_buffer(index_buffer.size() / 2.f, color);
